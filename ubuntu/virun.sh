...
#EXTENDED_SERVICES_DIR="./extended-services"
V3_EXTENDED_SERVICES_DIR="./v3/extended-services"
#DEFAULT_DIR="./default"
vdV3EnvPath="./v3/env-files/vd.env"
RELATIVE_PATH=/v3
#REVERSE_PROXY_HTTPS_FILE=${REVERSE_PROXY_HTTPS_YML}.yml
CERTS_DIR="../certs/"
UTILS_DIR="./v3/utils"
V3_DIR="./v3/"
...
menu[menu0]="Запустить/Перезапустить платформу"
menu[menu1]="Остановить платформу"
menu[menu2]="Ввести лицензионный ключ"
menu[menu3]="Изменить параметры запуска .."
menu[menu4]="Изменить настройки платформы .."
menu[menu5]="Диагностика .."
menu[menu6]="Бэкап/восстановление .."
menu[menu7]="${EXIT}"

menu2[menu21]="Изменить порт"
menu2[menu22]="Изменить адрес"
menu2[menu23]="Включить/выключить SSL"
menu2[menu24]=${BACK}
menu2[menu25]="Версии для запуска"

menu3[menu301]="Переключение типа логирования Loki"
menu3[menu316]="Включить адрес в docker dns"
menu3[menu302]="Установить SSL сертификаты"
menu3[menu303]="Создать кластер Clickhouse"
menu3[menu306]="Запретить/Разрешить встраивать iframe на сторонние сайты"
menu3[menu307]="Отключение/Включение мониторинга"
menu3[menu308]="Отключение/Включение админки Keycloak"
menu3[menu309]="${BACK}"
menu3[menu310]="Отключение/Включение внешниго Keycloak"
menu3[menu311]="Ускорение запросов к Clickhouseа"
menu3[menu312]="Изменение времени ротации логов Loki"
menu3[menu313]="Изменении предельного размера таблицы для удаления в Clickhouse"
menu3[menu314]="Изменение таймаута Http запроса для Clickhouse"
menu3[menu315]="Изменение временной зоны Clickhouse"
menu3[menu317]="Добавить драйвер БД"
menu3[menu318]="Настройка почты"
menu3[menu319]="Настройка сетевой папки"

menu4[menu43]="Сбор логов"
menu4[menu41]="${BACK}"
menu4[menu42]="Запущенные сервисы"

menu5[menu52]="Бэкап"
menu5[menu51]="Восстановление"
menu5[menu53]="${BACK}"
...
while true; do
  ...
  case "${menu_link}" in
    ...
    *)
      tput cup ${execute_start_row} 0; tput cud1
      $key
      printf "\n\n%s" "${MAGENTA}${PRESS_ANY_KEY}${MAGENTA}"
      read -rn 1
      ;;
  esac
done
